...
class WaterbirdsDataset(Dataset):
    """
    Returns a compatible Torch Dataset object customized for the Waterbirds dataset
    """
    SPLITS = {
        'tr': 0,
        'va': 1,
...
def load_waterbirds_data(is_training, batch_size, image_dir='images', metadata_path="", resampling=False, resol=299,
    ...
    dataset = WaterbirdsDataset(split, metadata_path, image_dir, n_classes, transform=preprocess)
...
class WaterbirdsConceptDataset:
