...
def load_metashift_data(is_training, batch_size, image_dir='images', metadata_path="", resampling=False, resol=299,
    ...
    dataset = MetaShiftDataset(split, metadata_path, image_dir, n_classes, transform=preprocess)
