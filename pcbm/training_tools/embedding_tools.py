...
def load_or_compute_projections(args, backbone, posthoc_layer, train_loader, test_loader, attempt_load=True):
    ...
    train_file = f"train-embs_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}.npy"
    test_file = f"test-embs_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}.npy"
    train_proj_file = f"train-proj_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}.npy"
    test_proj_file = f"test-proj_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}.npy"
    train_lbls_file = f"train-lbls_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}_lbls.npy"
    test_lbls_file = f"test-lbls_{args.dataset}__{args.backbone_name}__{conceptbank_source}__{args.seed}_lbls.npy"
    ...
    if attempt_load and os.path.exists(train_proj_file):
