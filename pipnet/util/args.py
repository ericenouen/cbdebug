...
def get_args() -> argparse.Namespace:
    ...
    parser.add_argument('--prune_weight_path',
                        type=str,
                        default='',
                        help='The directory containing the user feedback for the given trained model.')
    ...
    parser.add_argument('--algorithm',
                        type=str,
                        default='Retrain',
                        help='Algorithms for Debugging and Finetuning')
